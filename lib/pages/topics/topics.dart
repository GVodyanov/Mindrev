...
class _TopicsState extends State<Topics> {
      ...
      result.add(
          Padding(
            ...
            child: ListTile(
              ...
              onTap: () {
                Navigator.pushNamed(context, '/materials', arguments: {'className' : className ,'selection' : i['name'], 'color' : color});
              },
            ),
          )
      );
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: Future.wait([text, topics]),
          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                if (snapshot.data[1].toString() != List.empty().toString()) Center(
                  child: ConstrainedBox(
                    ...
                    child: ListView (
                      ...
                      children: ListTile.divideTiles(
                        context: context,
                        tiles: [for (Widget i in displayTopics(snapshot.data![1], routeData['color'], routeData['selection'])) i]
                      ).toList(),
                    ),
                  ),
                ),
