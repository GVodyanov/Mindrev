      ...
      result.add(
        Padding (
          ...
          child: ListTile(
            ...
            onTap: () {
              Navigator.pushNamed(context, '/topics', arguments: {'selection' : i['name'], 'color' : i['color']});
            },
          ),
        )
      );
  ...
  return FutureBuilder(
      ...
      builder: (BuildContext ctx, AsyncSnapshot<dynamic> snapshot) => snapshot.hasData
          ? Scaffold(
            ...
            //appbar
            appBar: AppBar(
              title: Text('Mindrev', style: TextStyle(color: theme.accent,
            ...
            body: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  if (snapshot.data[2].toString() != List.empty().toString()) Center(
                    child: ConstrainedBox(
                      ...
                      child: ListView (
                        ...
                        children: ListTile.divideTiles(
                          context: context,
                          tiles: [for (Widget i in displayClasses(snapshot.data[2])) i]
                        ).toList(),
                      ),
                    ),
                  ),
